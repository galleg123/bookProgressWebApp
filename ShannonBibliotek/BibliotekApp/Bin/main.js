...
function addBook(name, start, end, currP = start) {
  ...
  currPageInput.placeholder = "Type current page number here";
  ...
  currPage.innerHTML = `Current page: ${currP} <br>Progress: ${(
    ((currP - start) / (end - start)) *
    100
  ).toFixed(2)}%`;
  ...
  inputButton.addEventListener("click", function (e) {
    ...
    currPage.innerHTML = `Current page: ${value} <br>Progress: ${(
